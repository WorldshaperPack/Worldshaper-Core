...
public class WSMachines {
	...
	public static MachineDefinition ULVMINER;

	public static void init() {
		if (WSConfig.REGISTER_WS_MACERATORS.get()) {
		...
		if (WSConfig.REGISTER_PARALLEL_MULTIS.get()) {
		...
		if (WSConfig.REGISTER_ULV_MINER.get()) {
			ULVMINER = REGISTRATE.machine("ulv_miner",
